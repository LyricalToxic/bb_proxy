...
def upgrade():
    ...
    op.create_table('statistics',
                    ...
                    sa.Column('from_timestamp', sa.TIMESTAMP(), nullable=False, server_default=sa.text('(CURRENT_TIMESTAMP)')),
                    sa.Column('to_timestamp', sa.TIMESTAMP(), nullable=False, server_default=sa.text('(CURRENT_TIMESTAMP)')),
